...
local colors = {
  none = 'NONE',
  fg0 = util.get_colors_from_colorscheme('GruvboxFg0'), --#fbf1c7
  ...
  bg0 = util.get_colors_from_colorscheme('GruvboxBg0'), --#282828
  ...
  aqua = util.get_colors_from_colorscheme('GruvboxAqua'), --#8ec07c
